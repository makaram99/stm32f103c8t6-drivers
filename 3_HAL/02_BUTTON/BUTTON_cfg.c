...
BUTTON_CONFIGS_t buttonsConfigs[] = {
    {BUTTON_0, GPIO_PIN_BUTTON_0, ACTIVE_LOW, DEBOUNCE_OFF},
    {BUTTON_1, GPIO_PIN_BUTTON_1, ACTIVE_LOW, DEBOUNCE_OFF},
    {BUTTON_2, GPIO_PIN_BUTTON_2, ACTIVE_LOW, DEBOUNCE_OFF},
};
