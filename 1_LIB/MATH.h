 ...
 * @return The radians.
 * @par Example:
 *      @code DEG2RAD(180.0f);      // returns PI           @endcode
 *      @code DEG2RAD(0.0f);        // returns 0.0f         @endcode
 *      @code DEG2RAD(-180.0f);     // returns -PI          @endcode
 *      @code DEG2RAD(360.0f);      // returns 2*PI         @endcode
 *      @code DEG2RAD(-360.0f);     // returns -2*PI        @endcode
 *      @code DEG2RAD(720.0f);      // returns 4*PI         @endcode
 *      @code DEG2RAD(-720.0f);     // returns -4*PI        @endcode
 *      @code DEG2RAD(255.0f);      // returns 4.45059      @endcode 
 **********************************************************************************/
 ...
 * @return The degrees.
 * @par Example:
 *      @code RAD2DEG(PI);          // returns 180.0f       @endcode
 *      @code RAD2DEG(0.0f);        // returns 0.0f         @endcode
 *      @code RAD2DEG(-PI);         // returns -180.0f      @endcode
 *      @code RAD2DEG(2*PI);        // returns 360.0f       @endcode
 *      @code RAD2DEG(-2*PI);       // returns -360.0f      @endcode
 *      @code RAD2DEG(4*PI);        // returns 720.0f       @endcode
 *      @code RAD2DEG(-4*PI);       // returns -720.0f      @endcode
 *      @code RAD2DEG(4.45059);     // returns 255.0f       @endcode
 **********************************************************************************/
 ...
 * @par Example:
 *      @code MIN(1.0f, 2.0f);      // returns 1.0f         @endcode
 *      @code MIN(2.0f, 1.0f);      // returns 1.0f         @endcode
 *      @code MIN(1.0f, 1.0f);      // returns 1.0f         @endcode
 *      @code MIN(2.0f, 2.0f);      // returns 2.0f         @endcode
 *      @code MIN(0.0f, -1.0f);     // returns -1.0f        @endcode
 *      @code MIN(-1.0f, 0.0f);     // returns -1.0f        @endcode
 *      @code MIN(-1.0f, -1.0f);    // returns -1.0f        @endcode
 *      @code MIN(-2.0f, -1.0f);    // returns -2.0f        @endcode
 *      @code MIN(-1.0f, -2.0f);    // returns -2.0f        @endcode
 **********************************************************************************/
 ...
 * @par Example:
 *      @code MAX(1.0f, 2.0f);      // returns 2.0f         @endcode
 *      @code MAX(2.0f, 1.0f);      // returns 2.0f         @endcode
 *      @code MAX(1.0f, 1.0f);      // returns 1.0f         @endcode
 *      @code MAX(2.0f, 2.0f);      // returns 2.0f         @endcode
 *      @code MAX(0.0f, -1.0f);     // returns 0.0f         @endcode
 *      @code MAX(-1.0f, 0.0f);     // returns 0.0f         @endcode
 *      @code MAX(-1.0f, -1.0f);    // returns -1.0f        @endcode
 *      @code MAX(-2.0f, -1.0f);    // returns -1.0f        @endcode
 *      @code MAX(-1.0f, -2.0f);    // returns -1.0f        @endcode
 **********************************************************************************/
 ...
 * @par Example:
 *      @code ABS(-1.0f);           // returns 1.0f         @endcode 
 *      @code ABS(1.0f);            // returns 1.0f         @endcode
 *      @code ABS(0.0f);            // returns 0.0f         @endcode
 *      @code ABS(-0.0f);           // returns 0.0f         @endcode
 **********************************************************************************/
 ...
 * @par Example:
 *      @code FLOOR(5.6f);          // returns 5            @endcode
 *      @code FLOOR(-5.3f);         // returns -6           @endcode
 *      @code FLOOR(1.33f);         // returns 1            @endcode
 *      @code FLOOR(-1.33f);        // returns -2           @endcode
 **********************************************************************************/
 ...
 * @par Example:
 *      @code CEIL(5.5f);   // returns 6     @endcode
 *      @code CEIL(-5.5f);  // returns -5    @endcode
 *      @code CEIL(1.33f);  // returns 2     @endcode
 **********************************************************************************/
 ...
 * @par Example:
 *      @code ROUND(1.6f);      // returns 2.0f         @endcode
 *      @code ROUND(-1.6f);     // 1.6f -2.0f           @endcode
 *      @code ROUND(1.33);      // returns 1.0f         @endcode
 *      @code ROUND(-1.33f);    // returns -1.0f        @endcode
 **********************************************************************************/
 ...
 * @par Example:
 *      @code FRACTION(1.6f);           // returns 0.6f         @endcode
 *      @code FRACTION(-1.6f);          // returns -0.6f        @endcode
 *      @code FRACTION(1.33f);          // returns 0.33f        @endcode
 *      @code FRACTION(-1.33f);         // returns -0.33f       @endcode
 *      @code FRACTION(1.0f);           // returns 0.0f         @endcode
 *      @code FRACTION(-1.0f);          // returns 0.0f         @endcode
 *      @code FRACTION(0.0f);           // returns 0.0f         @endcode
 **********************************************************************************/
 ...
 * @par Example:
 *      @code LERP(1.0f, 2.0f, 0.5f);           // returns 1.5f         @endcode
 *      @code LERP(1.0f, 2.0f, 0.0f);           // returns 1.0f         @endcode
 *      @code LERP(1.0f, 2.0f, 1.0f);           // returns 2.0f         @endcode
 *      @code LERP(1.0f, 2.0f, 2.0f);           // returns 2.0f         @endcode
 *      @code LERP(1.0f, 2.0f, -1.0f);          // returns 1.0f         @endcode
 *      @code LERP(1.0f, 2.0f, -2.0f);          // returns 1.0f         @endcode
 *      @code LERP(1.0f, 2.0f, 3.0f);           // returns 2.0f         @endcode
 *      @code LERP(1.0f, 2.0f, -3.0f);          // returns 1.0f         @endcode
 **********************************************************************************/
